function [freq_local,H_local,H_gen_local,infoMODE,line_prop] = line_fit(H,frq,fmin,fmax)
...
//
//  Synthax :
//  [freq_local,H_local,H_gen_local,infoMODE,line_prop] = line_fit(H,frq,fmin,fmax)
//
//  Input data:
...
freq_local = frq(index_low:index_high,1) ;
...
H_gen_local = B./(wr^2-ww_local.^2+%i*loss_factor*wr^2) ;
