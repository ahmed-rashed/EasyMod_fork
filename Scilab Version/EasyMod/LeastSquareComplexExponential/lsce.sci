function [lsce_res,infoFRF,infoMODE] = lsce(H,frq,infoFRF)
...
//
//  Synthax:
//  [lsce_res,infoFRF,infoMODE] = lsce(H,frq,infoFRF) 
//
//  Input data:
...
HH = H ;
[MatIRs] = gen_resp_impul(HH,frq,infoFRF) ;
...
// Stabilization chart
stabdiag(FTEMP,XITEMP,TESTXI,FMAX,MaxMod,HH,frq) ;

// Least squares error chart visualization
subplot(2,2,3) ;
plot2d('nl',epsilon,style = 2) ;
